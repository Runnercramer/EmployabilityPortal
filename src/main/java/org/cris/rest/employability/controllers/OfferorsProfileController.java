...
@RestController
@RequestMapping("offerors/profile")
public class OfferorsProfileController {
    private ProfilesService profilesService;

    @Autowired
    public OfferorsProfileController(ProfilesService profilesService) {
    ...
    public ResponseEntity<Object> getOfferorProfile(@PathVariable String id) {
